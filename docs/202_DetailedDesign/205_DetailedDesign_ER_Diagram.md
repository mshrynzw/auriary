erDiagram
	...
	m_user_daily_defaults {
		...
		SMALLINT sleep_quality_default  "NOT NULL [1-5]"  
		SMALLINT wake_level_default  "NOT NULL [1-5]"  
		SMALLINT daytime_level_default  "NOT NULL [1-5]"  
		SMALLINT pre_sleep_level_default  "NOT NULL [1-5]"  
		SMALLINT med_adherence_level_default  "NOT NULL [1-5]"  
		SMALLINT appetite_level_default  "NOT NULL [1-5]"  
		SMALLINT sleep_desire_level_default  "NOT NULL [1-5]"  
		BIGINT source_id  "NULL"  
		TIMESTAMPTZ created_at  "NOT NULL"  
		TIMESTAMPTZ updated_at  "NOT NULL"  
		TIMESTAMPTZ deleted_at  "NULL"  
	...
	t_diaries {
		...
		SMALLINT sleep_quality  "NULL [1-5]"  
		SMALLINT wake_level  "NULL [1-5]"  
		SMALLINT daytime_level  "NULL [1-5]"  
		SMALLINT pre_sleep_level  "NULL [1-5]"  
		SMALLINT med_adherence_level  "NULL [1-5]"  
		SMALLINT appetite_level  "NULL [1-5]"  
	...
	t_medication_intakes {
		...
		SMALLINT adherence_score  "NULL [1-5]"  
		TEXT note  "NULL"  
		BIGINT source_id  "NULL"  
		TIMESTAMPTZ created_at  "NOT NULL"  
		TIMESTAMPTZ updated_at  "NOT NULL"  
